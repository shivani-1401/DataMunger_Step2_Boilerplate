...
public class QueryParser {
    ...
    public QueryParameter parseQuery(String queryString) {
        ...
        queryParameter.setRestrictions(getCondition(queryString));
    ...
    public List<String> getFields(String queryString) {
        ...
        String[] tempStorage = queryString.substring(startIndex, endIndex).split(",");
        List<String> fields = new ArrayList<String>(Arrays.asList(tempStorage));
        return fields;
    ...
    public List<Restriction> getCondition(String queryString) {
